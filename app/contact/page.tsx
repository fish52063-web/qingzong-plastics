                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <select required className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                      ...
                      <option value="plastic-bags">塑膠袋</option>
                      <option value="plastic-film">塑膠膜</option>
                      <option value="plastic-rope">塑膠繩</option>
                      <option value="plastic-net">塑膠網</option>
                      <option value="plastic-line">塑膠線</option>
                      <option value="recycled">再製原料</option>
                      <option value="custom">客製化產品</option>
